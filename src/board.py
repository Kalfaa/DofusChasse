...
class Board:
    ...
    def word_checker(self,word):
        bugged_word = {"quinerepoussepas": "Souche qui ne repousse pas", "Stéle en pierre": "Stèle en pierre","Ecoulement de séve":"Ecoulement de sève","Squelette d'humanoide":"Squelette d'humanoïde","Ocuf dans son nid":"Oeuf dans son nid","Caisse de pécheur Direction":"Caisse de pêcheur Direction","Manométre":"Manomètre","Baton avec une corde":"Bâton avec une corde","Plante eventail":"Plante éventail",'Panneau "Eleveurs”':'Panneau \"Eleveurs\"',"Fléche plantée dans le sol":"Flèche plantée dans le sol","Arbre a feuilles trouées":"Arbre à feuilles trouées","Crane de Dragon":"Crâne de Dragon" ,"Ponten pierre":"Pont en pierre", "Abrien toile" : "Abri en toile","Rouleau de métal posé sur la tra":"Rouleau de métal posé sur la tranche"}
